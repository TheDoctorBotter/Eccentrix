...
export default function PtEvaluationNotePage() {
  ...
  const fetchDefaultTemplate = async () => {
    try {
      const response = await fetch('/api/templates?noteType=pt_evaluation');
      if (response.ok) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-8">Document Initial Evaluation</h1>
          ...
          <Card className="border-2 border-blue-200">
            ...
            <CardContent>
              <p className="text-slate-600 mb-4">
                Review your inputs above, then click the button below to generate your professional PT Evaluation note.
              </p>
