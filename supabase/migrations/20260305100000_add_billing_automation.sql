-- ============================================================================
-- BILLING AUTOMATION MODULE — Additive Migration
-- Adds: patient_insurance, charge_capture_drafts, billing_audit_log,
--        invoices, invoice_lines, claim_number_seq, and columns on
--        existing visit_charges, claims, prior_authorizations, provider_profiles.
-- Safety: All IF NOT EXISTS / ADD COLUMN IF NOT EXISTS. No renames.
-- ============================================================================

-- ============================================================================
-- 0. Add 'biller' to clinic_role enum (needed for billing access control)
-- ============================================================================
